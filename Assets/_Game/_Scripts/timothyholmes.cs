...
public class timothyholmes : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler
{
    public bool altacorrea = false;
    [System.Serializable]
    public class grantwinn : UnityEvent { }
    [SerializeField]
    private grantwinn myOwnEvent = new grantwinn();
    public grantwinn onMyOwnEvent { get { return myOwnEvent; } set { myOwnEvent = value; } }
